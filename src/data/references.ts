...
export const clientReferences: ClientReference[] = [
  { name: 'Mirka P.', website: 'mircinamydla.cz', quote: 'Skvelá spolupráca, rýchle služby, zaujímavé nápady na zlepšenie.', quoteEn: 'Great cooperation, fast service, interesting ideas for improvement.' },
  ...
  { name: 'Petra A.', website: 'sleepsheep.cz', quote: 'Som veľmi spokojná – skvelá spolupráca, výborná komunikácia. Programátor je ochotný, spoľahlivý a vždy nápomocný. Spolupracujeme aj naďalej a môžem len odporučiť!', quoteEn: 'I\'m very satisfied – great cooperation, excellent communication. The developer is willing, reliable and always helpful. We continue to work together and I can only recommend!' },
  ...
  { name: 'Luděk N.', website: 'kurovky.cz', quote: 'Profesionálne znalosti, ľudský prístup a vcítenie sa do našich predstáv pri nastavovaní Shoptetu. Plánujeme ďalšiu spoluprácu v marketingu a grafike.', quoteEn: 'Professional expertise, a human approach and real understanding of our vision when setting up Shoptet. We\'re planning further cooperation on marketing and graphics.' },
